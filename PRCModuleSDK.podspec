#
#  Be sure to run `pod spec lint PRCModuleSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "PRCModuleSDK"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of PRCModuleSDK."
  ...
  spec.author             = { "chris781245" => "chris781245@hotmail.com" }
  # Or just: spec.author    = "chris781245"
  # spec.authors            = { "chris781245" => "chris781245@hotmail.com" }
  # spec.social_media_url   = "https://twitter.com/chris781245"
